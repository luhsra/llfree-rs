...
use llfree::{Alloc, Classing, HUGE_FRAMES, Init, LLFree, MetaData};
...
fn main() {
    ...
    let ms = Allocator::metadata_size(&classing, frames);
    ...
    for _ in 0..iterations {
        ...
        let alloc = Allocator::new(frames, Init::FreeAll, &classing, meta).unwrap();
